...
for(i in 1:length(scanIDs)){
  ...
  Warp1 = paste0(out.dir, scanIDs[i], "_", experiment, "_1Warp.nii.gz")
  GenericAffine = paste0(out.dir, scanIDs[i], "_", experiment, "_0GenericAffine.mat")
  
  antsApplyTransforms(fixed = ref.img, 
                      moving = mov.img, 
                      transformlist = c(Warp1, GenericAffine),
                      interpolator = "linear", 
